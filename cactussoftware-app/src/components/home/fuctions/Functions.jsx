...
const Functions = () => {
    ...
    return (
        <>
            <div class="feature-1 py-6 md:py-12 bg-gray-900 text-white">
                <div class="container px-4 mx-auto">
                    <div class="flex -mx-4">
                        <div class="px-4 text-center md:w-10/12 xl:w-8/12 mx-auto">
                            <h1 class="mb-4 text-3xl font-medium">Visión, Pasión y Compromiso</h1>
                            <p class="mb-4 text-xl">DevHub nació de la necesidad de fusionar la excelencia tecnológica con la creatividad sin límites. Este espacio se concibió como un ecosistema donde desarrolladores, innovadores y entusiastas de la tecnología pueden colaborar, aprender y crear juntos.</p>
                        </div>
                    </div>
