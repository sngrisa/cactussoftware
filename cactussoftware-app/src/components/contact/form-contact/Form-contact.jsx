        ...
        <div class="container px-4">
          <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4 lg:w-7/12 xl:w-8/12">
              <div class="ud-contact-content-wrapper">
                <div class="ud-contact-title mb-12 lg:mb-[150px]">
                  <span class="block mb-6 text-base font-medium text-white">
                    Contacto
                  </span>
                  <h2 class="max-w-[260px] text-[35px] leading-[1.14] font-semibold text-white">
                ...
                <div class="flex flex-wrap justify-between mb-12 lg:mb-0">
                  ...
                  <div class="mb-8 flex w-[330px] max-w-full">
                    ...
                    <div>
                      <h5 class="mb-[18px] text-lg font-semibold text-dark dark:text-white">Nuestro correo</h5>
                      <p class="text-base text-body-color dark:text-dark-6">cactus.studio.ar@gmail.com</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-full px-4 lg:w-5/12 xl:w-4/12">
              <div
                class="wow fadeInUp rounded-lg bg-white py-10 px-8 shadow-testimonial dark:shadow-none sm:py-12 sm:px-10 md:p-[60px] lg:p-10 lg:py-12 lg:px-10 2xl:p-[60px]"
                data-wow-delay=".2s">
                <h3 class="mb-8 text-2xl font-semibold md:text-[28px] md:leading-[1.42] dark:text-dark">
                  Dejenos un mensaje:
                </h3>
                <form>
                  <div class="mb-[22px]">
