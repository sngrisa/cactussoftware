...
const Aboutmin = () => {
  return (
    <>
      ...
      <section
        id="about"
        class="bg-gray-1 pb-8 pt-20 dark:bg-dark-2 lg:pb-[70px] lg:pt-[120px] mt-16"
      >
        <div class="container">
            ...
            <div class="-mx-4 flex flex-wrap items-center">
              <div class="w-full px-4 lg:w-1/2">
                <div class="mb-12 max-w-[540px] lg:mb-0">
                  ...
                  <p
                    class="mb-10 text-base leading-relaxed text-white"
                  >
                    En DevHub, creamos soluciones de software a medida para impulsar su éxito. Con un equipo apasionado por la tecnología, nos dedicamos a entender las necesidades de nuestros clientes y ofrecer soluciones innovadoras y de alta calidad. Desde aplicaciones móviles hasta sistemas empresariales, estamos aquí para convertir sus ideas en realidad.
                    <br />
                    <br />
                  </p>
                </div>
